...
function petSection(): string {
  ...
  <b>預けている自分の鳥からも仕掛けられます</b>ので、
  交配所どうしの♂と♀でも、どちらかが押せば成立します(引き取る必要はありません)。
...
<section class="man-sec">
  ...
  <ul>
    ...
    <li>敵には<b>5段階の属性相性</b>があります: ◎2.0倍 / ○1.5倍 / −等倍 / △0.6倍 / ✕0.25倍。
    着弾の一撃だけでなく、<b>継続ダメージ(延焼・腐蝕)にも同じ倍率が掛かります</b></li>

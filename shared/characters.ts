...
export const CHARACTERS: CharacterDef[] = [
  // 帽子が縦を食うぶん顔が小さく見えるので少し大きく表示する
  { id: 0, name: '黒金の魔女', note: '魔導書を手に、真理を読み解く', scale: 1.06 },
  // 1人だけ頭が大きい(測定 顔幅46.5% / 他は30〜44%)ので小さく表示する
  { id: 1, name: '白銀の学士', note: '記録と観測を重んじる研究者', scale: 0.88 },

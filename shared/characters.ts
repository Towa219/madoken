...
// 測定値(両目の幅 / 全身の高さ): 35.5% / 43.2% / 32.0% / 36.0% / 27.5% / 43.5%(平均 36.3%)
// 黒金・白銀・蒼氷は測定値より大きめ(指定で1.2倍)。並べた時の見栄えを優先している。
// 翠緑だけは逆に小さくしてある。深いフードのぶん髪込みの頭が242pxと
// 飛び抜けて大きく(他は174〜199px)、同じ高さで並べると頭でっかちに見えるため。
// 倍率は全身にかかるので、そのぶん背は低くなる。
// 特に白銀と蒼氷は両目の幅が最大(43.2% / 43.5%)なので、大きくすると頭の大きさも
// 目立つ。それでも小さく見える方が気になるという判断で、揃えるより見栄えを取った。
export const CHARACTERS: CharacterDef[] = [
  { id: 0, name: '黒金の魔女', note: '雷を操り、魔導書に真理を読む',
    element: 'thunder', scale: 1.20 },
  { id: 1, name: '白銀の学士', note: '水を読み、記録と観測を重んじる',
    element: 'water', scale: 1.08 },
  { id: 2, name: '紅蓮の戦導士', note: '炎を纏い、前へ出て杖を振るう',
    element: 'fire', scale: 1.10 },
  { id: 3, name: '翠緑の薬導士', note: '風を扱い、調合と薬に通じた癒し手',
    element: 'wind', scale: 0.92 },
  { id: 4, name: '紫紺の導師', note: '大地を鎮める、古き術の大魔導士',
    element: 'earth', scale: 1.10 },
  { id: 5, name: '蒼氷の術士', note: '氷を結び、静けさの中で術を編む',
    element: 'ice', scale: 1.08 },
];
